...
export const AddToCartDialog = ({data}) => {
  ...
  return (
   <>
     <Button onClick={handleOpen} startIcon={<ShoppingCartOutlined/>} fullWidth variant={'contained'}
     ...
     <Dialog open={open} onClose={handleClose} fullWidth>
       ...
       <form onSubmit={formik.handleSubmit}>
         <DialogContent>
           <Grid container spacing={1}>
             <Grid item md={6} xs={12}>
               <TextField name={'size'} select label={'Chosee Size'} fullWidth value={formik.values.size}
               ...
               >
                 {data?.price?.map((ele, index) => (
                  <MenuItem key={index} value={ele.size}>
                    <Box width={'100%'} display={'flex'} alignItems={'center'} justifyItems={'space-between'}>
             ...
             <Grid item md={6} xs={12}>
               <TextField fullWidth name={'quantity'}
             ...
             <Grid item md={12} xs={12}>
               <TextField variant={'standard'} label={'Notes'} fullWidth name={'notes'} value={formik.values.notes}
                          onChange={formik.handleChange}/>
             </Grid>
           </Grid>
         ...
         <DialogActions>
           ...
           <Button type={'submit'} color={'success'} endIcon={<ShoppingCartOutlined/>}> Add To Cart </Button>
         </DialogActions>
       </form>
     </Dialog>
