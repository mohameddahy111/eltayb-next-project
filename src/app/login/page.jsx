...
export default function Page() {
  ...
  const {decodeUserInfo, mobileDivices, userInfo} = Store()
       ...
       <form style={{width: '90%', margin: 'auto'}} onSubmit={formik.handleSubmit}>
         <Grid container spacing={1}>
           <Grid item xs={12} md={12}>
             <TextField id="email" label="  Email or Mobile"
                        variant="outlined"
           ...
           <Box pt={2} display={'flex'} alignItems={'center'} justifyContent={'space-between'} width={'100%'}>
             ...
             <Grid item md={6} display={"flex"} justifyContent={"end"}>
               <Typography textTransform="capitalize" component={'a'} color={'#09c'} href={'/forgot-password'}>
                 forget password?
               </Typography>
             </Grid>
           </Box>
